...
contract GeoERC20 is ERC20Permit, Managable {
    ...
    constructor() ERC20("Geo", "Geo", 9) ERC20Permit() {
    ...
    /**
        @notice increases Geo supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Geo
